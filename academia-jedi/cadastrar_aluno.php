...
<html>
  <head>
    ...
    <title>Academia Jedi - Cadastro de aluno</title>
...
<section class="hero">
    ...
    <div class="container">
      ...
      <div class="container has-text-centered">
        ...
        <?php
                    if(isset($_SESSION['nome_existe'])):
                    ?>
                    <div class="notification is-info">
                        <p>O nome escolhido já existe. Informe outro e tente novamente.</p>
                    </div>
                    <?php
                    endif;
  ...
  <div class="control">
    <input name="nomealuno" class="input is-rounded" type="text" placeholder="Digite o nome completo">
  </div>
</div>
...
<div class="field">
  ...
  <div class="control">
    <input name="email" class="input is-rounded" type="text" placeholder="Digite o endereço de e-mail">
  </div>
</div>
...
<div class="field">
  ...
  <div class="control">
    <input name="endereco" class="input is-rounded" type="text" placeholder="Digite o endereço completo">
  </div>
</div>
...
<div class="field">
  ...
  <div class="control">
    <input name="altura" class="input is-rounded" type="text" placeholder="Digite a altura">
  </div>
</div>
...
<div class="field">
  ...
  <div class="control">
    <input name="peso" class="input is-rounded" type="text" placeholder="Digite o peso">
  </div>
</div>
<br></br>
