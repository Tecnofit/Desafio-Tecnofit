...
class NamesGenerator
{
     ...
     * Please, for any amazing man that you add to the list, consider adding an equally amazing woman to it, and vice
     * versa.
     */
    public const RIGHT_NAME = [

        // Muhammad ibn Jābir al-Ḥarrānī al-Battānī was a founding father of astronomy.
        // https://en.wikipedia.org/wiki/Al-Battani
        "albattani",

        // Frances E. Allen, became the first female IBM Fellow in 1989.
        // In 2006, she became the first female recipient of the ACM's Turing Award.
        ...
        // She was the first woman to write a mathematics handbook and the first woman appointed as a Mathematics
        ...
        // Wanda Austin - Wanda Austin is the President and CEO of The Aerospace Corporation, a leading architect for
        // the US security space programs.
        ...
        // Buckaroo Banzai and his mentor Dr. Hikita perfected the "oscillation overthruster", a device that allows
        // one to pass through solid matter.
        ...
        // with inventing the first practical telephone.
        ...
        // Sue Black - British computer scientist and campaigner. She has been instrumental in saving Bletchley Park,
        // the site of World War II codebreaking.
        ...
        // algorithm that made possible the picture first visualization of a black hole using the Event Horizon
        // Telescope.
        // https://en.wikipedia.org/wiki/Katie_Bouman
        "bouman",

        // Evelyn Boyd Granville - She was one of the first African-American woman to receive a Ph.D. in mathematics;
        // she earned it in 1949 from Yale University.
        ...
        // Linda Brown Buck - American biologist and Nobel laureate best known for her genetic and molecular analyses
        // of the mechanisms of smell.
        // https://en.wikipedia.org/wiki/Linda_B._Buck
        "buck",

        // Dame Susan Jocelyn Bell Burnell - Northern Irish astrophysicist who discovered radio pulsars and was the
        // first to analyse them.
        // https://en.wikipedia.org/wiki/Jocelyn_Bell_Burnell
        "burnell",

        // Annie Jump Cannon - pioneering female astronomer who classified hundreds of thousands of stars and created
        // the system we use to understand stars today.
        ...
        // Dame Mary Lucy Cartwright - British mathematician who was one of the first to study what is now known as
        // chaos theory. Also known for Cartwright's theorem which finds applications in signal processing.
        ...
        // With Robert Elliot Kahn, he designed TCP and IP, the primary data communication protocols of the Internet
        ...
        // was a Russian and Soviet physicist, mathematician, and mechanical engineer. He is known for mathematical
        // formulas such as Chaplygin's equation and for a hypothetical substance in cosmology called Chaplygin gas,
        // named after him.
        ...
        // known for her translation of and commentary on Isaac Newton's book Principia containing basic laws of
        // physics.
        ...
        // drugs for treatment of epilepsy and malaria.
        ...
        // analytical geometry and number theory.
        ...
        // field of anonymous communication.
        ...
        // Also an accomplished numismatist.
        ...
        // Prize in science, and the first woman to be awarded the Nobel Prize in Physiology or Medicine.
        ...
        // computers that were the fastest in the world for decades.
        ...
        // development of the Indian space programme.
        ...
        // development of both quantum mechanics and quantum electrodynamics.
        ...
        // CEO of Palm, Inc. and co-founding Handspring.
        ...
        // and one of the first African-Americans in her field.
        ...
        // Taher A. ElGamal - Egyptian cryptographer best known for the ElGamal discrete log cryptosystem and the E
        ...
        // James Henry Ellis - British engineer and cryptographer employed by the GCHQ. Best known for conceiving for
        // the first time, the idea of public-key cryptography.
        ...
        // Yuri Alekseyevich Gagarin - Soviet pilot and cosmonaut, best known as the first human to journey into outer
        // space.
        // https://en.wikipedia.org/wiki/Yuri_Gagarin
        "gagarin",

        // Galileo was a founding father of modern astronomy, and faced politics and obscurantism to establish
        // scientific truth.
        //  https://en.wikipedia.org/wiki/Galileo_Galilei
        "galileo",

        // Évariste Galois - French mathematician whose work laid the foundations of Galois theory and group theory,
        // two major branches of abstract algebra, and the subfield of Galois connections, all while still in his late
        // teens.
        // https://en.wikipedia.org/wiki/%C3%89variste_Galois
        "galois",

        // Kadambini Ganguly - Indian physician, known for being the first South Asian female physician, trained in
        // western medicine, to graduate in South Asia.
        // https://en.wikipedia.org/wiki/Kadambini_Ganguly
        "ganguly",

        // William Henry "Bill" Gates III is an American business magnate, philanthropist, investor, computer
        ...
        // including number theory, algebra, statistics, analysis, differential geometry, geodesy, geophysics,
        // mechanics, electrostatics, magnetic fields, astronomy, matrix theory, and optics.
        // https://en.wikipedia.org/wiki/Carl_Friedrich_Gauss
        "gauss",

        // Marie-Sophie Germain - French mathematician, physicist and philosopher. Known for her work on elasticity
        // theory, number theory and philosophy.
        ...
        // Winner of 2012 ACM Turing Award.
        ...
        // Physiology or Medicine for the discovery of telomerase.
        // https://en.wikipedia.org/wiki/Carol_W._Greider
        "greider",

        // Alexander Grothendieck - German-born French mathematician who became a leading figure in the creation of
        ...
        // United Kingdom (which is widely considered as one of the safest designs).
        ...
        // co-operation with Whitfield Diffie and Ralph Merkle.
        ...
        // Grete Hermann was a German philosopher noted for her philosophical work on the foundations of quantum
        // mechanics.
        ...
        // Jaroslav Heyrovský was the inventor of the polarographic method, father of the electroanalytical method,
        // and recipient of the Nobel Prize in 1959. His main field of work was polarography.
        ...
        // Erna Schneider Hoover revolutionized modern communication by inventing a computerized telephone switching
        // method.
        ...
        // Hypatia - Greek Alexandrine Neoplatonist philosopher in Egypt who was one of the earliest mothers of
        // mathematics
        ...
        // printing press and water gauge.
        ...
        // black woman to travel in space when she served as a mission specialist aboard the Space Shuttle Endeavour
        ...
        // Mary Lou Jepsen, was the founder and chief technology officer of One Laptop Per Child (OLPC), and the
        // founder of Pixel Qi.
        ...
        // Irène Joliot-Curie - French scientist who was awarded the Nobel Prize for Chemistry in 1935. Daughter of
        ...
        // scientific TV show, Evident, but Incredible. His father was the Nobel laureate Soviet-era physicist Pyotr
        // Kapitsa, and his brother was the geographer and Antarctic explorer Andrey Kapitsa.
        ...
        // Omar Khayyam - Persian mathematician, astronomer and poet. Known for his work on the classification and
        // solution of cubic equations, for his contribution to the understanding of Euclid's fifth postulate and for
        // computing the length of a year very accurately.
        ...
        // Donald Knuth - American computer scientist, author of "The Art of Computer Programming" and creator of the
        ...
        // systems and was the winner of the 2013 Turing Award.
        ...
        // Henrietta Swan Leavitt - she was an American astronomer who discovered the relation between the luminosity
        // and the period of Cepheid variable stars.
        ...
        // Inge Lehmann - Danish seismologist and geophysicist. Known for discovering in 1936 that the Earth has a
        // solid inner core inside a molten outer core.
        // https://en.wikipedia.org/wiki/Inge_Lehmann
        "lehmann",

        // Daniel Lewin - Mathematician, Akamai co-founder, soldier, 9/11 victim-- Developed optimization techniques
        // for routing traffic on the internet. Died attempting to stop the 9-11 hijackers.
        ...
        // educator, and popularizer, and was the primary modern proponent for the significance of symbiosis in
        // evolution.
        // https://en.wikipedia.org/wiki/Lynn_Margulis
        "margulis",

        // Yukihiro Matsumoto - Japanese computer scientist and software programmer best known as the chief designer
        ...
        // Maria Mayer - American theoretical physicist and Nobel laureate in Physics for proposing the nuclear shell
        ...
        // Barbara McClintock - a distinguished American cytogeneticist, 1983 Nobel Laureate in Physiology or Medicine
        // for discovering transposons.
        ...
        // Dmitri Mendeleev - a chemist and inventor. He formulated the Periodic Law, created a farsighted version of
        // the periodic table of elements, and used it to correct the properties of some already discovered elements
        // and also to predict the properties of eight elements yet to be discovered.
        ...
        // and was a co-developer of the Morse code
        ...
        // May-Britt Moser - Nobel prize winner neuroscientist who contributed to the discovery of grid cells in the
        // brain.
        ...
        // Statistical Society and a pioneer in statistical graphics
        ...
        // (January 23 [O.S. January 10] 1909 – August 30, 1985) was a Russian-American Mayanist scholar and
        // archaeologist who contributed significantly to the deciphering of Maya hieroglyphs, the writing system of
        ...
        // astrologer, and poet of a single epigram in the Greek Anthology
        ...
        // Sally Kristen Ride was an American physicist and astronaut. She was the first American woman in space, and
        // the youngest American astronaut.
        // https://en.wikipedia.org/wiki/Sally_Ride
        "ride",

        // Rita Levi-Montalcini - Won Nobel Prize in Physiology or Medicine jointly with colleague Stanley Cohen for
        ...
        // Satoshi Nakamoto is the name used by the unknown person or group of people who developed bitcoin, authored
        // the bitcoin white paper, and created and deployed bitcoin's original reference implementation.
        // https://en.wikipedia.org/wiki/Satoshi_Nakamoto
        "satoshi",

        // Adi Shamir - Israeli cryptographer whose numerous inventions and contributions to cryptography include the
        // Ferge Fiat Shamir identification scheme, the Rivest Shamir Adleman (RSA) public-key cryptosystem, the
        // Shamir's secret sharing scheme, the breaking of the Merkle-Hellman cryptosystem, the TWINKLE and TWIRL
        // factoring devices and the discovery of differential cryptanalysis (with Eli Biham).
        ...
        // Lina Solomonovna Stern (or Shtern; Russian: Лина Соломоновна Штерн; 26 August 1878 – 7 March 1968) was a
        // Soviet biochemist, physiologist and humanist whose medical discoveries saved thousands of lives at the
        // fronts of World War II. She is best known for her pioneering work on blood–brain barrier, which she
        // described as hemato-encephalic barrier in 1921.
        // https://en.wikipedia.org/wiki/Lina_Stern
        "shtern",

        // Françoise Barré-Sinoussi - French virologist and Nobel Prize Laureate in Physiology or Medicine; her work
        // was fundamental in identifying HIV as the cause of AIDS.
        ...
        // Cynthia Solomon - Pioneer in the fields of artificial intelligence, computer science and educational
        // computing. Known for creation of Logo, an educational programming language.
        ...
        // Winner of 2014 ACM Turing Award.
        ...
        // Janese Swanson (with others) developed the first of the Carmen Sandiego games. She went on to found Girl
        // Tech.
        // https://en.wikipedia.org/wiki/Janese_Swanson
        "swanson",

        // Aaron Swartz was influential in creating RSS, Markdown, Creative Commons, Reddit, and much of the internet
        // as we know it today. He was devoted to freedom of information on the web.
        ...
        // Valentina Tereshkova is a Russian engineer, cosmonaut and politician. She was the first woman to fly to
        // space in 1963. In 2013, at the age of 76, she offered to go on a one-way mission to Mars.
        ...
        // Her work led to the acceptance of the theories of plate tectonics and continental drift.
        ...
        // dihydroartemisinin, used to treat malaria, which has saved millions of lives.
        // Joint winner of the 2015 Nobel Prize in Physiology or Medicine.
        ...
        // Dorothy Vaughan was a NASA mathematician and computer programmer on the SCOUT launch vehicle program that
        // put America's first satellites into space
        ...
        // Christiane Nüsslein-Volhard - German biologist, won Nobel Prize in Physiology or Medicine in 1995 for
        ...
        // differential geometry and statistical mechanics.
        ...
        // Malcolm John Williamson - British mathematician and cryptographer employed by the GCHQ. Developed in 1974
        // what is now known as Diffie-Hellman key exchange (Diffie and Hellman first published the scheme in 1976).
        ...
        // Chien-Shiung Wu - Chinese-American experimental physicist who made significant contributions to nuclear
        // physics.
        ...
        // Whereas contemporary scientists scoffed at the idea of human flight, Zhukovsky was the first to undertake
        // the study of airflow. He is often called the Father of Russian Aviation.
    ...
    {
        $leftName  = ucfirst(self::LEFT_NAME[random_int(0, count(self::LEFT_NAME) - 1)]);
        $rightName = ucfirst(self::RIGHT_NAME[random_int(0, count(self::RIGHT_NAME) - 1)]);

        return sprintf("%s %s", $leftName, $rightName);
    }
}
