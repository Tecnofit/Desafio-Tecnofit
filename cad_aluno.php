    ...
    <div class="container">
        ...
        <form id='mForm'>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="idNome" name="nome_aluno" placeholder="Nome Completo">
                </div>
            </div>
            <div class="form-group row">
                <label for='validationCustom02' class="col-sm-2 col-form-label">Idade</label>
                <div class="col-sm-2">
                    <input type="text" class="form-control" id="idIdade" name="idade">
                </div>
            </div>
            <div class="form-group row">
                <label for="inputEmail3" class="col-sm-2 col-form-label">Email</label>
                <div class="col-sm-10">
                    <input type="email" class="form-control" id="idEmail" name="email_contato" placeholder="Email">
                </div>
            </div>
            <div class="form-group row">
        ...
        $( "form" ).submit( function ( event ) {
             ...
             $.ajax({
                     ...
                     success: function(result){
                            ...
                            $('#mForm input[type = email]').val("");
                            $('#mForm input[type = password]').val("");
