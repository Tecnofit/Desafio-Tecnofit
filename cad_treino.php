    ...
    <div class="container">
        ...
        <form id='mForm'>
            <div class="form-group row">
                ...
                <div class="col-sm-10">                    
                    <input type="text" class="form-control" id="idCod" name="cod_treino" placeholder="Codigo do Treino">
                </div>
            </div>

            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Nome do Treino</label>
                <div class="col-sm-10">                    
                    <input type="text" class="form-control" id="idNome" name="nome_treino" placeholder="Nome Treino">
                </div>
            </div>
        ...
        $( "form" ).submit( function ( event ) {
            ...
            if(nomeTreino && codTreino){
                ...
                $.ajax({
                    ...
                    $('#mensagem').html("<div class='alert alert-warning' role='alert'>Atenção , é necessário adicionar um treino</div>");
            }
